    ...
    <Layout title="About">
      ...
      <div className="mt-3">
        <p className="mb-3">
          ...
          Reactjs and blockchain development. I haven't
        ...
        <p className="mb-3">
          I was born in Cilegon, Banten. Started learn programming language
          since December, 2019. Actually, I knew about programming since
          2017, but i'm not focused to learn programming language.
        </p>
        <p className="mb-3">
          i'am really sure, i can contribute in company
          or start-up.
        </p>
      </div>
    </Layout>
