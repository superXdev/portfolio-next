    ...
    return (
        <>
            ...
            <div className='container mx-auto max-w-screen-xl relative' onMouseMove={animationMouse} onClick={animationClickCircle} onTouchStart={startTouchAnimation}>
                ...
                <footer className='font-light fixed  bottom-0 sm:bottom-1 left-0 right-0 sm:right-20 flex flex-col sm:items-end  pb-3 cursor-default sm:text-base items-center text-xs'>
                    <div className='flex items-center'>Built with Next Js and Tailwind <span className='ml-3 block bg-love-icon w-4 h-4 bg-cover'></span> </div>
